...
| `app.js` | Adaptación de inputs al motor y presentación del resultado |
...
| `scripts/app_shell_release.py` | Fingerprint canónico del release |
...
```bash
npm run check:invariants   # contrato clínico/arquitectura/privacidad
...
3. actualizar motor y UI por separado;
4. pasar toda la red de seguridad;
5. quedar explícitamente identificado como cambio clínico en el PR.
...
Para el detalle y la deuda técnica vigente, revisar [`docs/engineering-baseline.md`](docs/engineering-baseline.md).
